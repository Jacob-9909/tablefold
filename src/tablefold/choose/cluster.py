...
* **Who is worth anchoring?** A :class:`~tablefold.choose.select.Selector`. Greedy set
  cover by default; see :mod:`tablefold.choose.select` for why that is a separate
...
from tablefold.choose.classify import TableProfile
from tablefold.choose.cost import MAX_MODEL_FIELDS, estimate_fields
